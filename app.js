...
//Use query selector to avoid using getElementBy ---
//We first target the section to work on using the ID
//then we indicate what is inside that section that we want to work with
